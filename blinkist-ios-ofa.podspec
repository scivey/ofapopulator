#
#  Be sure to run `pod spec lint blinkist-ios-ofa.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "blinkist-ios-ofa"
  s.version      = "0.0.1"
  s.summary      = "A fork of the OFA Populator offers an easy to implement yet powerful way to populate table and collection views."
